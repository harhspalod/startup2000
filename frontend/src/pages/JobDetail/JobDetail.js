...
const JobDetail = () => {
  ...
  const fetch = async () => {
    ...
    await axios
      .get(`https://startopia-backend.onrender.com/api/v1/job/me`, {
        headers: {
    ...
    await axios
      .get(
        `https://startopia-backend.onrender.com/api/v1/job/getJob/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    await axios
      .get(
        `https://startopia-backend.onrender.com/api/v1/job/getApplicants/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    await axios
      .get(
        `https://startopia-backend.onrender.com/api/v1/job/hired/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      .then(async (res) => {
        if (res.data.applicant.length > 0) {
          ...
          await axios
            .get(
              `https://startopia-backend.onrender.com/api/v1/job/getPayment/${id}`,
              {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
